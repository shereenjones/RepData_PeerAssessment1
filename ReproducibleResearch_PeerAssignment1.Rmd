...
```{r aggregatebyday}
    ...
    colnames(df1b) <- c("date", "average_stes")
...
```{r dailymean}
    df1_mean <- mean(df1a$total_steps)
...
##### Special note: Plot shows as line graph in R Studio, but not in R markdown.  Not sure why!
...
```{r aggregateperinterval}
    ...
    plot(df2a$interval, df2a$average_steps, type="l", col="blue",
...
### There is little impact of imputing missing data.  The overall shape of the graph is basically unchanged.
...
##### Again problems with the line graph!  Fine in R Studio but not in the HTML file produced from knitr

2.Make a panel plot containing a time series plot (i.e. type = "l") of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all weekday days or weekend days (y-axis). See the README file in the GitHub repository to see an example of what this plot should look like using simulated data.

```{r plot4}    
    qplot(interval, average_steps, data=df5, facets= wdaytype ~ .) + geom_line()
```   
